  ...
  return (
    <div className="app-shell">
      ...
      <div className="main-area">
        <header className="mobile-top"><button className="icon-btn" onClick={() => setOpen(true)}><Menu size={20}/></button><Link className="mobile-brand" to="/"><img src="/elvra-logo.png" alt="ELVRA"/>ELVRA</Link><button className="icon-btn" onClick={() => navigate('/profile')}><UserRound size={19}/></button></header>
        {children}
      </div>
    </div>
  )
